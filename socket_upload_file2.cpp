...
int main() {
    ...
    while (true) {
        ...
        // Recibir metadatos del archivo (nombre y tamaño)
        ...
        // Obtener el nombre del archivo del buffer
        ...
        std::cout << "Archivo recibido y guardado correctamente: " << fileName << std::endl;
